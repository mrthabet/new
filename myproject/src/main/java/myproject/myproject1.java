...
public class ScreenshotTest {
    ...
    private static String getFrameworkUrl(String url) throws Exception {
        WebDriver driver = new ChromeDriver();
        driver.get(url);

        // Get the framework URL
        String frameworkUrl = driver.findElement(By.xpath("//*[@id=\"framework-info\"]/div[1]/a")).getAttribute("href");
